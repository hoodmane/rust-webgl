...
impl ShaderIndexed {
    ...
    pub fn create_geometry(&self) -> GeometryIndexed {
        ...
        let index_buffer = self.webgl.create_buffer();
        self.webgl.bind_buffer(WebGl2RenderingContext::ELEMENT_ARRAY_BUFFER, index_buffer.as_ref());
    ...
    fn check_geometry(&self, geometry : &GeometryIndexed) -> Result<(), JsValue> {
    ...
    fn check_geometry_buffer_sizes(&self, _geometry : &GeometryIndexed) -> Result<(), JsValue> {
    ...
    pub fn set_attribute_point(&self, geometry : &mut GeometryIndexed, name : &str, data : &[Point]) -> Result<(), JsValue> {
    ...
    fn set_attribute_data<T : MutPtrF32>(&self, geometry : &mut GeometryIndexed, loc : u32, attribute_size : usize, data : &T) -> Result<(), JsValue> {
    ...
    pub fn set_indices(&self, geometry : &mut GeometryIndexed, indices : &[u16]) -> Result<(), JsValue> {
        self.check_geometry(geometry)?;
        self.webgl.bind_vertex_array(geometry.attribute_state.as_ref());
        geometry.num_vertices = (indices.len()) as i32;
        unsafe {
    ...
    pub fn draw_indexed(&self, geometry : &GeometryIndexed, primitive : u32) -> Result<(), JsValue> {
        self.check_geometry_buffer_sizes(geometry)?;
        self.webgl.bind_vertex_array(geometry.attribute_state.as_ref());
        self.webgl.draw_elements_with_i32(
            primitive,
